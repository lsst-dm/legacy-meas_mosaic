...
PYBIND11_MODULE(shimCameraGeom, mod) {
    ...
    mod.def("getCenterInFpPixels", getCenterInFpPixels);
    mod.def("getCenterInDetectorPixels", getCenterInDetectorPixels);
    mod.def("getWidth", getWidth);
    mod.def("getHeight", getHeight);
